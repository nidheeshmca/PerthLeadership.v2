...
public class FoaResultConfiguration : IEntityTypeConfiguration<FoaResult>
{
    public void Configure(EntityTypeBuilder<FoaResult> builder)
    {
        builder.ToTable("FOA_Results");
