...
public class CfoaResultConfiguration : IEntityTypeConfiguration<CfoaResult>
{
    public void Configure(EntityTypeBuilder<CfoaResult> builder)
    {
        builder.ToTable("CFOA_Results");
